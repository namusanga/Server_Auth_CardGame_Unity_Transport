...
public class Client : NetworkBehaviour
{
    ...
    public override void RegisterMessageHandlerClasses()
    {
        ...
        //MAKE HANDLERS
        new Test_MessageHandlerClass(this);
    }
    ...
    public override void UnregisterMessageHandlerClasses()
    {
        ...
        //REMOVE HANDLERS
        RemoveMessageHandler(NetworkProtocal.EmptyMessage);
    }
    ...
    public virtual void OnClientConnected()
    {
        ...
        TimerManager.Active.AddTimer(2, SendKeepAlive);
    }
    ...
    public void SendKeepAlive()
    {
        ...
        {
            Debug.Log(LogPrefix + "Sendling keep alive messgage");
        }

        //SEND KEEP ALIVE
        SendMessageToServer(new KeepAliveMessage());
